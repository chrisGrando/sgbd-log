...
pwsh -version >nul 2>&1 && (
    ...
    start "Windows PowerShell (Core)" pwsh.exe -ExecutionPolicy Bypass -File "%script_path%\scripts\windows\ExportToolkit.ps1"
) || (
	:: Newer version of PowerShell was NOT found, fallback to default
    start "Windows PowerShell (5.1?)" PowerShell.exe -ExecutionPolicy Bypass -File "%script_path%\scripts\windows\ExportToolkit.ps1"
)
